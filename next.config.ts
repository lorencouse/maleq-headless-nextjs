      ...
      },
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              "default-src 'self'",
              `script-src 'self' 'unsafe-inline'${process.env.NODE_ENV === 'development' ? " 'unsafe-eval'" : ''} https://js.stripe.com https://www.googletagmanager.com https://www.google-analytics.com https://static.cloudflareinsights.com`,
              "style-src 'self' 'unsafe-inline'",
              "img-src 'self' data: blob: https: http:",
              "media-src 'self' https://*.maleq.com https://*.maleq.org",
              "font-src 'self' data:",
              "connect-src 'self' https://*.stripe.com https://www.google-analytics.com https://*.google-analytics.com https://analytics.google.com https://*.maleq.com https://*.maleq.org https://www.googletagmanager.com https://cloudflareinsights.com",
