...
export default function Header() {
  ...
  return (
    <header className='bg-background border-b border-border transition-colors sticky top-0 z-40' role="banner">
      <nav className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8' aria-label={t('mainNav')}>
        <div className='flex justify-between h-16 items-center'>
          ...
          <div className='flex items-center space-x-1'>
            ...
            {/* Language Switcher — replaces the desktop wishlist shortcut.
                Wishlist is still reachable via the User menu dropdown and
                via the Mobile drawer's Quick Actions. */}
            <LanguageSwitcher />
