      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-green-700 dark:text-green-400 text-sm mb-3">
            We stand behind every product we sell. If you&apos;re not completely satisfied with your
            purchase, contact us within 30 days for a hassle-free return or exchange.
          </p>
