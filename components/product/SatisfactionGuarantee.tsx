...
export default function SatisfactionGuarantee({
  ...
  return (
    <div
      className={`p-6 bg-background from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-xl border border-green-200 dark:border-green-800 select-none ${className}`}
    >
      <div className='flex items-start gap-4'>
        <div className='flex-shrink-0 w-14 h-14 rounded-full bg-background flex items-center justify-center'>
          <svg
        ...
        <div className='flex-1'>
          ...
          <Link
            href='/returns'
            className='inline-flex items-center gap-1 mt-3 text-sm font-medium text-green-700 dark:text-green-300 hover:text-green-800 dark:hover:text-green-200 transition-colors'
          >
            View return policy
            <svg
              className='w-4 h-4'
