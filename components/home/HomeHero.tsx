      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
            ...
            <span className="text-primary block mt-2">Delivered Discreetly</span>
          </h1>

          {/* Subheading */}
          <p className="text-lg sm:text-xl text-zinc-300 mb-10 max-w-2xl mx-auto">
            Shop our curated collection of quality products with expert guides and unsponsored reviews to help you choose with confidence.
          </p>
