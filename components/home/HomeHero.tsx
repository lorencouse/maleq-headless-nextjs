    ...
    <section className='relative bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 text-white select-none'>
      ...
      <div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24'>
        <div className='max-w-3xl'>
          ...
          {/* Heading */}
          <h2 className='heading-plain text-2xl sm:text-3xl lg:text-4xl font-bold mb-6 leading-tight'>
            {t('headingMain')}{' '}
          ...
          <div className='flex flex-col sm:flex-row gap-4'>
            <Link
              href='/shop'
              className='inline-flex items-center justify-center gap-2 bg-primary text-white px-8 py-4 rounded-xl font-semibold text-lg hover:bg-primary-hover transition-colors shadow-lg shadow-primary/25'
            >
              {t('shopNow')}
              <svg
                className='w-5 h-5'
          ...
          <div className='flex flex-wrap gap-6 mt-10 pt-8 border-t border-white/10'>
            ...
            >
              ...
              <span>{t('trustPlainPackaging')}</span>
            </Link>
            <Link
              href='/shipping-returns'
              className='flex items-center gap-2 text-sm text-zinc-300 hover:text-white transition-colors'
