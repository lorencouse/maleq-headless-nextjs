...
const socialLinks = [
  ...
  {
    name: 'Facebook',
    href: 'https://facebook.com/maleqofficial',
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'Instagram',
    href: 'https://instagram.com/maleqofficial',
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'Twitter',
    href: 'https://twitter.com/maleqofficial',
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">
            Stay up-to-date with the latest news, guides, and exclusive content
          </p>
        </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6">
            ...
            <div className="text-center sm:text-left flex-1">
              <h3 className="text-xl font-bold text-foreground mb-2">
                Subscribe to MQ on YouTube
              </h3>
              <p className="text-muted-foreground mb-4">
                Get in-depth video guides, product reviews, and expert advice on our YouTube channel.
              </p>
              <Link
                href="https://youtube.com/@maleq"
                target="_blank"
