...
- [x] `[MED]` Do page testing on Safari (WebKit smoke passed locally against production on 2026-02-24 via Playwright: `e2e/home.spec.ts`, `e2e/shop.spec.ts`, `e2e/cart.spec.ts`)
