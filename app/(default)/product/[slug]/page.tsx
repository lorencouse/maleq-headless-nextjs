  ...
  return (
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8 lg:py-12">
      ...
      {/* Product Details with Image Gallery.
          Deliberately NOT wrapped in <Suspense>: nothing in this tree suspends
          any more (VariationSelector no longer reads useSearchParams), and a
          boundary here let React flush the skeleton fallback first and stream
          the real gallery/H1/price/add-to-cart into a hidden segment — so the
          visible HTML crawlers parse was a skeleton (SEO audit finding C1). */}
