      ...
      <section className="py-16 md:py-20 bg-primary text-primary-foreground">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            <Link
              href="/shop"
              className="inline-flex items-center gap-2 px-8 py-4 bg-background text-foreground text-xs font-bold uppercase tracking-[0.12em] rounded-lg hover:bg-muted transition-colors"
            >
              {t('ctaShop')}
            ...
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 px-8 py-4 bg-transparent border-2 border-primary-foreground/50 text-primary-foreground text-xs font-bold uppercase tracking-[0.12em] rounded-lg hover:bg-white/10 transition-colors"
            >
              {t('ctaContact')}
            </Link>
          </div>
