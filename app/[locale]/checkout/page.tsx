...
export default function CheckoutPage() {
  ...
  const hasRedirectPaymentIntent = Boolean(searchParams.get('payment_intent'));
  ...
  useEffect(() => {
    if (isEmpty && !hasRedirectPaymentIntent) {
      router.push('/cart');
    }
  }, [isEmpty, hasRedirectPaymentIntent, router]);
